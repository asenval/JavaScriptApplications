...
var snakeGame = (function() {
  ...
  var Snake = MovingGameObject.extend({
    init: function(position, speed, direction) {
      var piece;
      var piecePosition;
      var foodForSpeedIncreasing = 5; // number of foods eaten to increase snake speed
    ...
    grow: function() {
      ...
      foodForSpeedIncreasing--;
      if (foodForSpeedIncreasing == 0) {
  ...
  var SnakeGame = Class.create({
    ...
    checkMovingSnakeToTheOtherSide: function () {
        var i;
    ...
    checkCollisions: function () {
        this.checkMovingSnakeToTheOtherSide();
        var i;
